...
function Lanyard() {
  return (
    <div style={{ display: "flex", justifyContent: "center", width: 276 }}>
      <svg width={64} height={235} viewBox="0 0 64 235" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Strap body */}
        <path d="M0 0H64V118C64 122.418 60.4183 126 56 126H8C3.58172 126 0 122.418 0 118V0Z" fill="#4E3A34"/>
        {/* Transparent clip body outline */}
...
// The clip tab sits at y:130.7 in the 235px lanyard SVG.
// The SVG is centered in the 276px container: left offset = (276-64)/2 = 106px.
// With -22px card overlap, card top is at y:213 — the tab extends ~21px onto the card.
function ClipTabOverlay() {
  return (
    <div
      style={{
        position: "absolute",
