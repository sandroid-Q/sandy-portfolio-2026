...
const ITEMS = [
  { src: "/beem-app-stickers/sticker-1.mp4", ar: "1 / 1" },
  ...
  { src: "/beem-app-stickers/sticker-5.mp4", ar: "1 / 1" },
];
...
// the two square clips (1,5) cap the ends, aligned with the side videos' tops.
const STAGGER = [
  { left: 0, top: 25.116 },
...
export default function BeemStickers() {
  ...
  // Mobile: the three tall videos in one carousel, the two square ones in a
  // second below — they're different shapes, so they get their own carousels.
  if (vw < 600) {
    return (
  ...
  // Mid: the three tall videos in a row, the two square ones centred below.
  if (vw < 1000) {
